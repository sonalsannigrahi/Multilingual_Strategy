...
PAIRS=('fi-en' 'et-en' 'hi-en' 'ne-en' 'gu-en' 'mr-en' 'be-en')
...
if [ ! -f $datadir/hi-en/train.hi-en.en ]; then
	...
	cat $datadir/hi-en/raw_corpora/iitb/parallel-n/IITB.en-hi.$lang >> $datadir/hi-en/raw_corpora/train.hi-en.$lang
    done
